...
DEFAULT_CONFIG = {
    ...
    "device_id": _env("PLANT_DEVICE_ID", "9c87ab1f-e4bb-4baf-9e3d-e767dab2b794"),
    "device_secret": _env("PLANT_DEVICE_SECRET", "DnVauv0zI7mBi1vIV7k5XeZsRxTfKW_M"),
    "sensor_ids": {
        "soil_moisture": _env("PLANT_SENSOR_SOIL_ID", "0f9ae0ca-071b-403f-b600-8382c11e0674"),
        "temperature": _env("PLANT_SENSOR_TEMP_ID", "bd0cbb8a-9d22-4396-ba7c-9e6bd6a52e2f"),
        "water_level": _env("PLANT_SENSOR_WATER_ID", "83a28e39-7fe9-4fbc-a03d-b08b17600340"),
    },
    "actuator_ids": {
        "pump": _env("PLANT_ACTUATOR_PUMP_ID", "2f07f9bd-638e-49ac-8f3b-6cb48900e92b"),
        "lamp": _env("PLANT_ACTUATOR_LAMP_ID", "b7623f00-7747-4072-bf01-7e332f2db4c8"),
    },
...
class PiClient:
    ...
    def push_telemetry(self) -> None:
        ...
        readings = [
            ...
            {
                "sensor_id": self.config.sensor_ids["temperature"],
                "timestamp": now,
